...
<body bgcolor="#B11502">
    ...
    $instru_SQL = "UPDATE registrodecuentas SET usuario='$nombre', id_cargo='$id_cargo' where id_registro='$id';";
    ...
    if($re==false){
        ...
        ?> <h1><?php echo "Registro actualizado";?></h1>
        <?php }
