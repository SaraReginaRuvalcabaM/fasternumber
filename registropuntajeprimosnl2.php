...
<body >
    ...
    $instru_SQL = "SELECT registrodecuentas.usuario,puntajejuegosprimos.num_primos_pun_nl2 From registrodecuentas,puntajejuegosprimos where registrodecuentas.id_registro=puntajejuegosprimos.id_registro order by puntajejuegosprimos.num_primos_pun_nl2  desc ;";
    ...
    if($re){
        ...
        <td class=d><?php echo $contra=$reg['num_primos_pun_nl2'];?></td>
        </tr>
