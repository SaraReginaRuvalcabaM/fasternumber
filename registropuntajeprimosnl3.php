...
<body >
    ...
    $instru_SQL = "SELECT registrodecuentas.usuario,puntajejuegosprimos.num_primos_pun_nl3 From registrodecuentas,puntajejuegosprimos where registrodecuentas.id_registro=puntajejuegosprimos.id_registro  order by puntajejuegosprimos.num_primos_pun_nl3  desc ;";
    ...
    if($re){
        ...
        <td class=d><?php echo $contra=$reg['num_primos_pun_nl3'];?></td>
        </tr>
    ...
    <input type=button value="Volver a jugar" class=botones onclick="top.juego.location='juegoprimonl3.html'"></center>
