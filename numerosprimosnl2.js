...
//Crea operaciones entre los números al azar
var num=numi+"+"+numi2;
...
//Después de 200 segundos de iniciar la ventana se sube el elemento con id form que implica el contador
    setTimeout('document.form.submit()', 200001)
}
function evaluar(){
    //Reproduce el audio
    var audio = new Audio('SonidoAguaAAA.mp3');
audio.play();
//Extrae el número de el elemento con el id contador en una variable var llamada contador
    var contador=Number(document.getElementById("contador").value);
    //Extrae la operación de el elemento con el id num1 en una variable var llamada num
    ...
    var numi=eval(num);
    // Se crea un bucle for el cual se repetira empezando con i de valor 1 hasta que sea un número menor antes del valor de numi
    for (var i=1; i<numi; i ++){
      //Si el valor de la variable numi entre el valor que tenga la variable i en esta vuelta del bucle for su residuo es 0 suma 1 a la variable contador1
      if (numi % i == 0){
        contador1 +=1;  }
      }
...
//Extrae el número de el elemento con el id contador en una variable var llamada contador
    var contador=Number(document.getElementById("contador").value);
    //Extrae la operación de el elemento con el id num2 en una variable var llamada num
...
//Extrae el número de el elemento con el id contador en una variable var llamada contador
    var contador=Number(document.getElementById("contador").value);
    //Extrae la operación de el elemento con el id num3 en una variable var llamada num
...
//Extrae el número de el elemento con el id contador en una variable var llamada contador
    var contador=Number(document.getElementById("contador").value);
    //Extrae la operación de el elemento con el id num4 en una variable var llamada num
...
//Extrae el número de el elemento con el id contador en una variable var llamada contador
    var contador=Number(document.getElementById("contador").value);
    //Extrae la operación de el elemento con el id num5 en una variable var llamada num
...
,4000)
//Este codigo hace que al iniciar el juego de los numeros primos del nivel 2 se reproduzca la cancion de fondo en bucle 
