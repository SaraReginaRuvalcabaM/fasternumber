...
window.onload=function(){
     // crea números al azar en rango de 1 y 20 para las variables numi, numi2, numi3, numi4, numi5,numi6, numi7, numi8, numi9, numi10
...
function evaluar(){
    ...
    var numix=eval(num);
    if (numix%2!=0 && contador>0){ // Resta 1 al contador si num es un número par y si contador es mayor que cero
        var re=contador-1;
    ...
    else if(numix%2!=0){//Si numix es un número impar
        // Genera nuevos números al azar para crear la operación para num que se mostrarán en el botón
        var numi = Math.floor((Math.random()*(21-1))+1);
        var numi2 = Math.floor((Math.random()*(21-1))+1);
                  //crea una multiplicación entre numi y numi2
...
function evaluar2(){
    ...
    audio.play();
       //Extrae el número de el campo con el id contador en una variable llamada contador
    var contador=Number(document.getElementById("contador").value);
        //Extrae la operación de el campo con el id num2 en una variable llamada num2
...
function evaluar3(){
    ...
    audio.play();
       //Extrae el número de el campo con el id contador en una variable llamada contador
    var contador=Number(document.getElementById("contador").value);
        //Extrae la operación de el campo con el id num3 en una variable llamada num3
...
function evaluar4(){
    ...
    audio.play();
       //Extrae el número de el campo con el id contador en una variable llamada contador
    var contador=Number(document.getElementById("contador").value);
        //Extrae la operación de el campo con el id num4 en una variable llamada num4
...
function evaluar5(){
    ...
    audio.play();
       //Extrae el número de el campo con el id contador en una variable llamada contador
    var contador=Number(document.getElementById("contador").value);
        //Extrae la operación de el campo con el id num5 en una variable llamada num5
...
,4000)
//Este codigo hace que al iniciar el juego de los numeros pares del nivel 3 se reproduzca la cancion de fondo en bucle
