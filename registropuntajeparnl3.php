...
<head>
    ...
    <link rel="stylesheet" href="registropun.css">
...
<body >
    ...
    $instru_SQL = "SELECT registrodecuentas.usuario,puntajejuegospares.num_pares_pun_nl3 From registrodecuentas,puntajejuegospares where registrodecuentas.id_registro=puntajejuegospares.id_registro order by puntajejuegospares.num_pares_pun_nl3  desc ;";
    ...
    if($re){
        ...
        <td class=d><?php echo $contra=$reg['num_pares_pun_nl3'];?></td>
        </tr>
