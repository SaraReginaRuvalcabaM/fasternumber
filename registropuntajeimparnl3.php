...
<body >
    ...
    $instru_SQL = "SELECT registrodecuentas.usuario,puntajejuegosimpares.num_impares_pun_nl3 From registrodecuentas,puntajejuegosimpares where registrodecuentas.id_registro=puntajejuegosimpares.id_registro order by puntajejuegosimpares.num_impares_pun_nl3  desc ;";
    ...
    if($re){
        ...
        <td class=d><?php echo $contra=$reg['num_impares_pun_nl3'];?></td>
        </tr>
