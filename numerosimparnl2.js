...
//Crea operaciones entre los números al azar asignando a variables de tipo var:num,num2,num3,num4,num5
var num=numi+"+"+numi2;
var num2=numi3+"-"+numi4;
var num3=numi5+"+"+numi6;
var num4=numi7+"-"+numi8;
var num5=numi9+"+"+numi10;
  // Asigna las operaciones creadas a los campos num, num2, num3, num4, num5
...
function evaluar(){
    ...
    if (numi%2==0 && contador>0){
          // Resta 1 al contador si num1 es un número par y el si contador es mayor que cero
        var re=contador-1;
    ...
    else if(numi%2==0){//Si numi es un número par
          // Genera nuevos números al azar para crear la operación para num que se mostrarán en el botón
        var numi = Math.floor((Math.random()*(101-1))+1);
        var numi2 = Math.floor((Math.random()*(101-1))+1);
         //crea una suma entre numi y numi2
...
function evaluar2(){
    ...
    var numi=eval(num);
    if (numi%2==0 && contador>0){
              // Resta 1 al contador si num2 es par y el contador es mayor que cero
        var re=contador-1;
        document.getElementById("contador").value=re;
             // Genera nuevos números al azar para crear la operación para num que se mostrarán en el botón
        var numi = Math.floor((Math.random()*(101-1))+1);
...
function evaluar3(){
    ...
    var numi=eval(num);
    if (numi%2==0 && contador>0){
              // Resta 1 al contador si num3 es par y el contador es mayor que cero
        var re=contador-1;
        document.getElementById("contador").value=re;
             // Genera nuevos números al azar para crear la operación para num que se mostrarán en el botón
        var numi = Math.floor((Math.random()*(101-1))+1);
...
function evaluar4(){
    ...
    var numi=eval(num);
    if (numi%2==0 && contador>0){
              // Resta 1 al contador si num4 es par y el contador es mayor que cero
        var re=contador-1;
        document.getElementById("contador").value=re;
            // Genera nuevos números al azar para crear la operación para num que se mostrarán en el botón
        var numi = Math.floor((Math.random()*(101-1))+1);
...
function evaluar5(){
    ...
    var numi=eval(num);
    if (numi%2==0 && contador>0){
              // Resta 1 al contador si num5 es par y el contador es mayor que cero
        var re=contador-1;
        document.getElementById("contador").value=re;
                  // Genera nuevos números al azar para crear la operación para num que se mostrarán en el botón
        var numi = Math.floor((Math.random()*(101-1))+1);
       ...
       // Genera nuevos números al azar para crear la operación para num que se mostrarán en el botón
        ...
        document.getElementById("num5").value = num;
         ...
         //Si el numero es impar el contador suma 1
        var re=contador+1;
        document.getElementById("contador").value=re;
         // Genera nuevos números al azar para crear la operación para num que se mostrarán en el botón
        var numi = Math.floor((Math.random()*(101-1))+1);
...
,3000)
//Este codigo hace que al iniciar el juego de los numeros impares del nivel 2 se reproduzca la cancion de fondo en bucle 
